...
import com.example.schoolvotingapp.PIO.LoadComments;
...
public class PIO extends ListActivity{
	...
	private static final String CANDIDATES_URL = "http://192.168.0.123/Electrovots/android/pio.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String id = preferences.getString(cPIOID, "00");
	...
	private void updateList() {
		...
		SimpleAdapter adapter = 
				new SimpleAdapter(PIO.this, mCandidateList, R.layout.position_content, 
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
					...
					//This is for testing
					/*Toast toast = Toast.makeText(PIO.this, "hello"+name.getText().toString(), Toast.LENGTH_SHORT);
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(PIO.this);
		...
		protected void onPostExecute(Boolean result) {
			...
			if (isConnected == false){
				Toast toast = Toast.makeText(PIO.this, "Cannot connect to Server!",Toast.LENGTH_LONG);
				toast.setGravity(Gravity.CENTER, 0, 0);
				toast.show();
			}
			else{
	...
	public void submit(View v){
		...
		edit.putString(cPIO, cName.getText().toString());
		edit.putString(cPIOID, cID.getText().toString());
		edit.putBoolean(cPIOSelected, true);
		edit.putBoolean(cVote_StraightSelected, false);
		edit.commit();
		
		String a=preferences.getString("cPIO", "");
		String b=preferences.getString("cPIOID", "");
	    ...
	    //This is for testing
		/*Toast toast = Toast.makeText(PIO.this, a+b, Toast.LENGTH_SHORT);
		toast.setGravity(Gravity.CENTER, 0, 0);
		toast.show();*/
	}
