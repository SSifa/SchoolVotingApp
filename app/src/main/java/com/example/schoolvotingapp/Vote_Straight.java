...
public class Vote_Straight extends ListActivity {
	...
	private static final String CANDIDATES_URL = "http://192.168.0.123/Electrovots/android/party_list.php";
	...
	public static final String cPresident = "cMalerep";
	public static final String cPresidentID = "cMalerepID";
	public static final String cPresidentSelected = "cMalerepSelected";

	public static final String cVice_President = "cFemalerep";
	public static final String cVice_PresidentID = "cFemalerepID";
	public static final String cVice_PresidentSelected = "cFemalerepSelected";
	...
	public void updateJSONdata() {
		...
		try {
			...
			for (int i = 0; i < mCandidates.length(); i++) {
				...
				String photoURL = "http://192.168.0.123/Electrovots" + c.getString(TAG_LOGO);
	...
	private void updateList() {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// This is for testing
				/*
				 * Toast toast = Toast.makeText(Femalerep.this,
	...
	public void submit(View v) {
		...
		// This is for testing
		/*
		 * Toast toast = Toast.makeText(Femalerep.this, c+"yow",
		 * Toast.LENGTH_SHORT); toast.setGravity(Gravity.CENTER, 0, 0);
		 * toast.show();
		 */
	}
